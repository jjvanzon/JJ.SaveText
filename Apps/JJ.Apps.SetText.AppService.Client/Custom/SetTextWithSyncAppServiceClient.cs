...
{
    public class SetTextWithSyncAppServiceClient : ISetTextWithSyncPresenter
    {
        ...
        {
            _serviceClient = new WcfSoapClient(url, typeof(ISetTextWithSyncAppService).Name);
        ...
        {
            SetTextViewModel viewModel2 = _serviceClient.Invoke<SetTextViewModel>("Synchronize", new SoapParameter("viewModel", viewModel), new SoapParameter("cultureName", _cultureName));
            return viewModel2;
        }
    }
}
