...
*SaveText* was an attempt to test a code architecture with an idea of *minimal functionality, maximal architecture*. The idea was, that when certain patterns work for simple situations, that might extend to more complex functionality. To see if the components can work together to accomplish technical desires. The results of that effort, is a proof of concept of techniques that might apply to more complex applications.
