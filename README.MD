...
*SaveText* was an attempt to test a code architecture with an idea of *minimal functionality, maximal architecture*. The idea was, that when certain patterns might work for simple situations, that might extend to more complex functionality. To see if the components can work together to accomplish technical desires. The results of that effort, is a proof of concept of techniques that might apply to more complex applications.
...
This project was from around 2015. Newer tech may have emerged or become available (e.g. .NET Standard, Xamarin, Angular, Unity Game Engine free in Visual Studio Community edition and .NET 5.0 and above). This project might not have been updated since then and was subjected to different constraints than now.
...
There used to be demos in this repository, not really related to the SaveText project. They can still be found in [JJ.SaveText.Archived](https://github.com/jjvanzon/JJ.SaveText.Archived/tree/master/Demos) under the same license.