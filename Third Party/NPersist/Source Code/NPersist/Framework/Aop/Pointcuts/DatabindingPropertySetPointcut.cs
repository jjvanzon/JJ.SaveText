...
{
    public class DatabindingPropertySetPointcut : IPointcut
    {
        ...
        private static IList CreateInterceptors()
        {
            ...
            arr.Add(new DatabindingPropertySetInterceptor());
            return arr;
        }

        public DatabindingPropertySetPointcut(IContext context)
        {
