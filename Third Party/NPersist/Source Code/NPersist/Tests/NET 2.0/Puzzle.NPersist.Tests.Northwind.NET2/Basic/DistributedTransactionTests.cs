...
{
	/// <summary>
	/// Summary description for DistributedTransactionTests.
	/// </summary>
	[TestClass(), Transaction(TransactionOption.Required)]
	public class DistributedTransactionTests : ServicedComponent
	{
		public DistributedTransactionTests()
		{
		}
