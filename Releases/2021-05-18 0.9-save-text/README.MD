...
- The WindowsPhone variation might have been deployed to a Microsoft Lumia phone for instance, using a version of Visual Studio (2012?) specifically tailored for Windows Phone.