...
namespace JJ.Framework.Exceptions.Tests
{
	...
	{
		[TestMethod]
		public void Test_NotUniqueException_WithExpression() => AssertHelper.ThrowsException<NotUniqueException>(
		    () =>
		    {
	    ...
	    [TestMethod]
		public void Test_NotUniqueExceptionOfT_NoKey() => AssertHelper.ThrowsException<NotUniqueException<TestItem>>(
	        () => throw new NotUniqueException<TestItem>(),
	        "TestItem not unique.");
