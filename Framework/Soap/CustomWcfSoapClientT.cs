...
namespace JJ.Framework.Soap
{
    ...
    {
        private readonly CustomWcfSoapClient _client;
        ...
        /// </summary>
        public CustomWcfSoapClient(string url) : this(url, Encoding.UTF8) { }

        /// <summary>
        /// This class exists because some mobile platforms running on Mono
        /// do not fully support System.ServiceModel or System.Web.Services.
        /// </summary>
        public CustomWcfSoapClient(string url, Encoding encoding) => _client = new CustomWcfSoapClient(url, typeof(TServiceInterface).Name, encoding);
            ...
            where TResult : class, new()
        {
            ...
            var result = _client.Invoke<TResult>(methodCallInfo.Name, soapParameters);
            return result;
        }
