...
namespace JJ.Framework.Soap
{
    ...
    public class SoapClient
    {
        ...
        private readonly SoapFormatter _soapFormatter;
        ...
        /// </summary>
        private readonly Func<string, string, string> _sendMessageDelegate;
            ...
            IEnumerable<CustomArrayItemNameMapping> customArrayItemNameMappings = null)
        {
            ...
            _url = url;
            _encoding = encoding ?? throw new NullException(() => encoding);
        ...
        public SoapClient(
            string url,
            Func<string, string, string> sendMessageDelegate,
            IEnumerable<SoapNamespaceMapping> namespaceMappings = null,
            IEnumerable<CustomArrayItemNameMapping> customArrayItemNameMappings = null)
        {
            if (string.IsNullOrEmpty(url)) throw new ArgumentException("url cannot be null or empty");
            ...
            where TResult : class, new()
        {
            ...
            var result = _soapFormatter.ParseStringReceived<TResult>(operationName, textReceived);
            return result;
        }
        ...
        private string SendMessage(string soapAction, string textToSend)
        {
            ...
            using (var response = (HttpWebResponse)request.GetResponse())
            {
                ...
                {
                    if (responseStream == null) throw new NullException(() => response.GetResponseStream());
